...
public class JsonAdaptedPersonTest {
    ...
    @Test
    public void toModelType_remark_preservesText() throws Exception {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, "Likes swimming!", VALID_TAGS);
        assertEquals(new PersonBuilder(BENSON).withRemark("Likes swimming!").build(), person.toModelType());
    }
