...
public class JsonAdaptedPersonTest {
    ...
    @Test
    public void toModelType_nullRemark_defaultsToEmpty() throws Exception {
    ...
    public void toModelType_nonEmptyRemark_preserved() throws Exception {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, "Call next week");
        assertEquals("Call next week", person.toModelType().getRemark().value);
    }
