...
public class LogicManagerTest {
    ...
    @Test
    public void execute_remark_updatesModelAndStorage() throws Exception {
        ...
        assertEquals(String.format(RemarkCommand.MESSAGE_ADD_REMARK_SUCCESS, Messages.format(edited)),
                result.getFeedbackToUser());
        assertEquals(edited, model.getFilteredPersonList().get(0));
